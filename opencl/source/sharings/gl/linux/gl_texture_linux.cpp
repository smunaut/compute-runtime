...
Image *GlTexture::createSharedGlTexture(Context *context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel, cl_GLuint texture,
    ...
    texIn.version = MESA_GLINTEROP_EXPORT_IN_VERSION;
    ...
    texOut.version = MESA_GLINTEROP_EXPORT_OUT_VERSION;
    ...
    if ((retValue != MESA_GLINTEROP_SUCCESS) || (texOut.version != MESA_GLINTEROP_EXPORT_OUT_VERSION)) {
        switch (retValue) {
